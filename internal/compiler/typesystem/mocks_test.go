...
func (m *MockexprValidator) Validate(arg0 ts.Expr) error {
	m.ctrl.T.Helper()
...
func (m *MockexprValidator) ValidateDef(def ts.Def) error {
	m.ctrl.T.Helper()
...
func (m *MockcompatChecker) Check(arg0, arg1 ts.Expr, arg2 ts.TerminatorParams) error {
	m.ctrl.T.Helper()
...
func (m *MockrecursionTerminator) ShouldTerminate(arg0 ts.Trace, arg1 ts.Scope) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockScope) GetType(ref string) (ts.Def, error) {
	m.ctrl.T.Helper()
...
func (m *MockScope) Update(ref string) (ts.Scope, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ref)
	ret0, _ := ret[0].(ts.Scope)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
