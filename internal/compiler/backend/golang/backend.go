...
import (
	...
	"github.com/nevalang/neva-lsp/internal"
	"github.com/nevalang/neva-lsp/internal/compiler"
	"github.com/nevalang/neva-lsp/internal/compiler/ir"
	"github.com/nevalang/neva-lsp/pkg"
	"github.com/nevalang/neva-lsp/pkg/ast"
	"github.com/nevalang/neva-lsp/pkg/golang"
	pkgos "github.com/nevalang/neva-lsp/pkg/os"
)
...
func (b Backend) EmitExecutable(dst string, prog *ir.Program, trace bool) error {
	...
	files := map[string][]byte{
		"main.go": buf.Bytes(),
		"go.mod":  []byte("module github.com/nevalang/neva-lsp/internal\n\ngo 1.25"),
	}
...
func (b Backend) EmitLibrary(dst string, exports []compiler.LibraryExport, trace bool) error {
	...
	if b.externalRuntimePath == "" {
		replacements := map[string]string{
			"github.com/nevalang/neva-lsp/internal/runtime": runtimeImportPath,
		}
